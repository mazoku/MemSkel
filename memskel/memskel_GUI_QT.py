...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.thresholding_GB.setMinimumSize(QtCore.QSize(0, 140))
        self.thresholding_GB.setMaximumSize(QtCore.QSize(16777215, 200))
        ...
        self.frame_9 = QtGui.QFrame(self.thresholding_GB)
        ...
        self.horizontalLayout_11 = QtGui.QHBoxLayout(self.frame_9)
        self.horizontalLayout_11.setMargin(0)
        self.horizontalLayout_11.setSpacing(4)
        self.horizontalLayout_11.setObjectName(_fromUtf8("horizontalLayout_11"))
        self.threshold_BTN = QtGui.QPushButton(self.frame_9)
        self.threshold_BTN.setCheckable(True)
        self.threshold_BTN.setObjectName(_fromUtf8("threshold_BTN"))
        self.horizontalLayout_11.addWidget(self.threshold_BTN)
        self.threshold_SB = QtGui.QSpinBox(self.frame_9)
        self.threshold_SB.setMaximumSize(QtCore.QSize(50, 16777215))
        self.threshold_SB.setMaximum(255)
        self.threshold_SB.setObjectName(_fromUtf8("threshold_SB"))
        self.horizontalLayout_11.addWidget(self.threshold_SB)
        self.verticalLayout_3.addWidget(self.frame_9)
        self.rectangle_ROI_BTN = QtGui.QPushButton(self.thresholding_GB)
        self.rectangle_ROI_BTN.setMinimumSize(QtCore.QSize(0, 30))
        self.rectangle_ROI_BTN.setCheckable(True)
        self.rectangle_ROI_BTN.setObjectName(_fromUtf8("rectangle_ROI_BTN"))
        self.verticalLayout_3.addWidget(self.rectangle_ROI_BTN)
        ...
        self.circle_ROI_BTN.setCheckable(True)
        ...
        self.circ_roi_radius_SB = QtGui.QSpinBox(self.frame_3)
        self.circ_roi_radius_SB.setMaximumSize(QtCore.QSize(50, 16777215))
        self.circ_roi_radius_SB.setProperty("value", 65)
        self.circ_roi_radius_SB.setObjectName(_fromUtf8("circ_roi_radius_SB"))
        self.horizontalLayout_5.addWidget(self.circ_roi_radius_SB)
        ...
        self.line_7 = QtGui.QFrame(self.control_F)
        self.line_7.setFrameShape(QtGui.QFrame.HLine)
        self.line_7.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_7.setObjectName(_fromUtf8("line_7"))
        self.verticalLayout_2.addWidget(self.line_7)
        self.process_stack_GB = QtGui.QGroupBox(self.control_F)
        self.process_stack_GB.setMinimumSize(QtCore.QSize(0, 60))
        self.process_stack_GB.setMaximumSize(QtCore.QSize(16777215, 60))
        self.process_stack_GB.setObjectName(_fromUtf8("process_stack_GB"))
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.process_stack_GB)
        self.verticalLayout_8.setMargin(0)
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName(_fromUtf8("verticalLayout_8"))
        self.segment_stack_BTN = QtGui.QPushButton(self.process_stack_GB)
        self.segment_stack_BTN.setMinimumSize(QtCore.QSize(0, 30))
        self.segment_stack_BTN.setObjectName(_fromUtf8("segment_stack_BTN"))
        self.verticalLayout_8.addWidget(self.segment_stack_BTN)
        self.verticalLayout_2.addWidget(self.process_stack_GB)
        ...
        self.line_9 = QtGui.QFrame(self.control_F)
        ...
        self.frame_4 = QtGui.QFrame(self.control_F)
        self.frame_4.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_4.setObjectName(_fromUtf8("frame_4"))
        self.horizontalLayout_6 = QtGui.QHBoxLayout(self.frame_4)
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.save_state_BTN = QtGui.QPushButton(self.frame_4)
        self.save_state_BTN.setObjectName(_fromUtf8("save_state_BTN"))
        self.horizontalLayout_6.addWidget(self.save_state_BTN)
        self.load_state_BTN = QtGui.QPushButton(self.frame_4)
        self.load_state_BTN.setObjectName(_fromUtf8("load_state_BTN"))
        self.horizontalLayout_6.addWidget(self.load_state_BTN)
        ...
        self.disp_seeds_BTN = QtGui.QPushButton(self.views_F)
        self.disp_seeds_BTN.setCheckable(True)
        self.disp_seeds_BTN.setObjectName(_fromUtf8("disp_seeds_BTN"))
        self.horizontalLayout_2.addWidget(self.disp_seeds_BTN)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.threshold_BTN.setText(_translate("MainWindow", "Threshold", None))
        ...
        self.label_7.setText(_translate("MainWindow", "radius:", None))
        ...
        self.segment_img_BTN.setText(_translate("MainWindow", "Segmentation", None))
        self.skeleton_GB.setTitle(_translate("MainWindow", "Skeleton", None))
        self.skeleton_BTN.setText(_translate("MainWindow", "Skeletonization", None))
        ...
        self.process_stack_GB.setTitle(_translate("MainWindow", "Processing stack", None))
        self.segment_stack_BTN.setText(_translate("MainWindow", "Segment stack", None))
        ...
        self.save_state_BTN.setText(_translate("MainWindow", "Save state", None))
        self.load_state_BTN.setText(_translate("MainWindow", "Load state", None))
        self.disp_roi_BTN.setText(_translate("MainWindow", "ROI", None))
        self.disp_seeds_BTN.setText(_translate("MainWindow", "seeds", None))
